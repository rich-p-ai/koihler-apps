...
generate_deployment_script() {
    ...
    cat > "$MIGRATION_DIR/migration-scripts/deploy-to-ocp-prd.sh" << 'EOF'
#!/bin/bash
...
EOF
    ...
    chmod +x "$MIGRATION_DIR/migration-scripts/deploy-to-ocp-prd.sh"
...
main() {
    ...
    print_info "🚀 Deploy using: $MIGRATION_DIR/migration-scripts/deploy-to-ocp-prd.sh"
    echo
    print_info "Next steps:"
    ...
    print_info "   c. Manual: ./$MIGRATION_DIR/migration-scripts/deploy-to-ocp-prd.sh"
